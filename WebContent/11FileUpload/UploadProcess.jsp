...
//전송될 파일의 최대용량을 지정한다. 단, 파일이 3개라면 3개의 합친 용량을 설정해야 한다.
int maxPostSize = 1024 * 1000;
/*
만약 제한 용량을 초과한다면 아래와 같은 예외가 발생하게 된다.
java.io.IOException : Posted content length of 1165348 exceeds limit of 1024000
*/
...
try {
	/*
	위에서 준비한 객체를 기반으로 MultipartRequest객체를 생성한다.
	...
	*/
	...
	/*
	파일을 제외한 나머지 폼값을 받아온다. 단, 이때 request객체를 
	통해서가 아니라 MultipartRequest 객체를 통해 받와야 한다.
	*/
	...
	if(cateArray==null) {
		...
		//체크박스를 통해 선택한 항목의 콤마를 통해 구분해서 저장.
