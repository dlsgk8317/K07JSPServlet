...
//Post 방식으로 전송되는 폼값을 받아 변수에 저장한다.
String color = request.getParameter("color");
String font = request.getParameter("font");
//최초접속을했을때 디폴트값으로 사용할 값을 설정한다.
...
<style type="text/css">
	/* styleSheet내에서 표현식이나 스크립트릿을 사용할 수 있다. */
	span {
		font-size : 2em;
		color: <%=color%>;
		font-family: <%=font%>;
...
<body>
	...
	if(counter != null) {
		/*
		toCharrray() : String을 char형 배열로 반환해주는 메소드
		*/
