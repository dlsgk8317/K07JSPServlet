...
String isPassword = request.getParameter("isPassword"); //패스워드 
String name = request.getParameter("name"); ///이름
String birthday = request.getParameter("birthday");//생년월일
String zipcodeFind = request.getParameter("zipcodeFind"); //우편번호
String inputEmail = request.getParameter("inputEmail");//이메일
...
param.setId(isPassword); //패스워드
param.setId(name); //이름
param.setId(birthday); //생일
param.setId(zipcodeFind); //우편번호
param.setId(inputEmail); // 이메일
param.setId(mobile1); //핸드폰번호
param.setId(tel1); //전화번호
--%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<form action="WriteProcess.jsp" method="post" name="loginFrm" onsubmit="return loginValdidate(this)">
<div class="AllWrap">
