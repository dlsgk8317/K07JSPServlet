<%--
	...
	지시어 (Directive) : 페이지 속성을 지정하거나 외부문서를
		포함할때 사용한다.(page, include, taglib이 있다.)
 --%>
...
<body>
	...
	스크립트릿(Scriptlet) : 주로 JSP코드를 작성하고 실행할때 사용하는
		영역이다. 스크립트릿은 head영역, body영역 어디서든 사용할수 
	...
	표현식(Expression) : 변수를 웹브라우저상에 출력할때 사용한다.
		JS의 docment.write()와 동일한 역할을 한다. 표현식 사용시
	...
	<br />
	<%
		//인수로 out 내장객체를 전달하며, 메소드에서는 이를 통해
		//웹브라우저에 변수를 출력할 수 있다.
