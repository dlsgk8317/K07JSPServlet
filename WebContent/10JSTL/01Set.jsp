...
<body>
	...
	<!-- 
	영역에 저장될떼 Object형으로 자동캐스팅 되므로 사용시 해당
	자료형으로 형변환 해야한다.
	...
	<!-- 
	EL로 출력시에는 별도로 형변환이 필요없고, 속성명의 중복이 없다면
	...
	<!-- 
	1. 변수설정. new를 통해 객체를 생성한 후 setAttribite()으로 영역에 저장
	 -->
	...
	정지훈에 대한 정보가 출력됨
	 -->
	<h4>target 및 property속성으로 미 설정후 출력</h4>
	<ul>
